...
// @version      MS6410_3.1.0.2
// @icon         https://www.google.com/s2/favicons?domain=125.185
// @match        http*://*/index.php?menu=user&func=user
// @grant        none
// @updateURL    https://openuserjs.org/meta/a29527806/眾至郵件伺服器增加密碼欄位及匯出清單功能.meta.js
// ==/UserScript==
		...
		downloadLink.onclick = function() {
			...
			for (var i = 0; i < rows.length; i++) {
				...
				for (var j = 1; j < cols.length-1; j++){
					...
					setCSVValue = setCSVValue.replace('https://203.74.125.185:88/imgs/createDate.png','建立日期');
					setCSVValue = setCSVValue.replace('https://203.74.125.185:88/imgs/activeEmail.png','啟用狀態');
					setCSVValue = setCSVValue.replace('https://203.74.125.185:88/imgs/enable.png','啟用');
					setCSVValue = setCSVValue.replace('https://203.74.125.185:88/imgs/disable.png','停用');
					setCSVValue = setCSVValue.replace('https://203.74.125.185:88/imgs/functions.png','');
