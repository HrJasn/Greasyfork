...
1. **申請 API Key**：
   ...
   * 目前的腳本設計會把所有現有選項傳送給AI分析，消耗權杖的量非常多，除非您知道自己在做什麼否則別先提供付費方式而導致啟動付費模式。
...
<video src="https://github.com/user-attachments/assets/f09ff970-41e5-4cbf-81ca-9ccc2b4b8810" controls="controls" width="100%">
  您的瀏覽器不支援 HTML5 影片標籤。
</video>
...
4. 目前的腳本設計會把所有現有選項傳送給AI分析，消耗權杖的量非常多，除非您知道自己在做什麼否則別先提供付費方式而導致啟動付費模式。
